...
export async function createSearchPanel(container, callbacks) {
  ...
  const showOnlyAuthorizedLabel = ph(placeholders, 'showOnlyAuthorizedAssets', 'Show only authorized assets');
      ...
      <div class="primary-panel-container">
        ...
        <div class="right-panel-group">
          <div class="card-view-container">
            <button class="grid-view-btn ${viewType === 'grid' ? 'active' : ''}" type="button" data-tooltip="${gridViewLabel}">
              <img src="/icons/gridview-${viewType === 'grid' ? 'active' : 'inactive'}.svg" alt="${gridViewLabel}" />
            </button>
            <button class="list-view-btn ${viewType === 'list' ? 'active' : ''}" type="button" data-tooltip="${listViewLabel}">
              <img src="/icons/listview-${viewType === 'list' ? 'active' : 'inactive'}.svg" alt="${listViewLabel}" />
            </button>
          </div>
          
          <button class="filter-button" type="button">
            <img src="/icons/Filter-search.svg" alt="${filterLabel}" class="filter-icon" />
      ...
      <div class="secondary-panel-container">
        ...
        <div class="left-panel-group">
          ...
          <div class="select-section">
            ${isRightsSearch ? `
              <label class="select-authorized">
                <input type="checkbox" id="select-authorized" ${selectAuthorized ? 'checked' : ''} />
                <span>${showOnlyAuthorizedLabel}</span>
              </label>
            ` : ''}
...
function bindEvents(container, callbacks) {
  ...
  if (gridBtn) {
    gridBtn.addEventListener('click', () => {
      ...
      gridBtn.querySelector('img').src = '/icons/gridview-active.svg';
      if (listBtn) {
        listBtn.classList.remove('active');
        listBtn.querySelector('img').src = '/icons/listview-inactive.svg';
      }
    });
  }
  ...
  if (listBtn) {
    listBtn.addEventListener('click', () => {
      ...
      listBtn.querySelector('img').src = '/icons/listview-active.svg';
      if (gridBtn) {
        gridBtn.classList.remove('active');
        gridBtn.querySelector('img').src = '/icons/gridview-inactive.svg';
      }
    });
  }
  ...
  // Select authorized checkbox
  const selectAuthorizedCheckbox = container.querySelector('#select-authorized');
  if (selectAuthorizedCheckbox) {
    selectAuthorizedCheckbox.addEventListener('change', (e) => onSelectAuthorized(e.target.checked));
  }
