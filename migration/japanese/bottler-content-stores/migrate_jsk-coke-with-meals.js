...
/**
 * Migrate JSK Coke With Meals page from AEM to EDS.
 * Largest campaign page with 35 images, 9 tab components, 16 buttons.
 *
 * USAGE:
 *   node migrate_jsk-coke-with-meals.js [--upload] [--dry-run]
 */
...
const PAGE_JCR_PATH = 'jcr_root/content/share/jp/ja/bottler-content-stores/studio-x-shopper/jsk-coke-with-meals';
...
const PAGE_SLUG = 'jsk-coke-with-meals';
...
const DA_PAGE_PATH = 'ja/bottler-content-stores/studio-x-shopper/jsk-coke-with-meals';
