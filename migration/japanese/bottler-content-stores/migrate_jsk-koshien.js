...
/**
 * Migrate JSK Koshien page from AEM to EDS.
 * Campaign page with: 4 images, 1 tab component, 10 buttons.
 *
 * USAGE:
 *   node migrate_jsk-koshien.js [--upload] [--dry-run]
 */
...
const PAGE_JCR_PATH = 'jcr_root/content/share/jp/ja/bottler-content-stores/studio-x-shopper/jsk-koshien';
...
const DA_PAGE_PATH = 'ja/bottler-content-stores/studio-x-shopper/jsk-koshien';
