...
/**
 * Migrate JSK Coke Meals page from AEM to EDS.
 * Coke Meals page with 11 images, 1 tab, 12 buttons, 1 teaser.
 *
 * USAGE:
 *   node migrate_jsk-coke-meals.js [--upload] [--dry-run]
 */
...
const PAGE_JCR_PATH = 'jcr_root/content/share/jp/ja/bottler-content-stores/jsk-coke-meals';
...
const PAGE_SLUG = 'jsk-coke-meals';
...
const DA_PAGE_PATH = 'ja/bottler-content-stores/jsk-coke-meals';
...
async function main() {
  ...
  const html = generateCampaignHtml(pageData, transformedButtons, transformedTabs, transformedTeasers, daImagesBase, transformUrl);
