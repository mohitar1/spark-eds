...
/**
 * Migrate JSK Summer Occasion page from AEM to EDS.
 * Campaign page with: 8 images, 2 tab components, 4 buttons.
 *
 * USAGE:
 *   node migrate_jsk-summer-occasion.js [--upload] [--dry-run]
 */
...
const PAGE_JCR_PATH = 'jcr_root/content/share/jp/ja/bottler-content-stores/studio-x-shopper/jsk-summer-occasion';
...
const PAGE_SLUG = 'jsk-summer-occasion';
...
const DA_PAGE_PATH = 'ja/bottler-content-stores/studio-x-shopper/jsk-summer-occasion';
