...
<head>
    ...
    <title>ATTENTION: Usage Rights Expiring</title>
...
<body style="height: 100%;margin: 0;padding: 0;width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #f5f5f5;">
    ...
    letter-spacing: normal;text-align: left;">									
                                                                                ...
                                                                                <h1 style="display: block;margin: 0;padding: 0;color: #212121;font-family: 'Raleway', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 26px;font-style: normal;font-weight: normal;line-height: 125%;letter-spacing: normal;text-align: center;">Rights Request NOT Created</h1><br /><br />

                                                                                <br /><br />
                                                                           Hello KO Assets User,
                                                                           <br /><br />
                                                                           There has been a problem with the creation of your Rights Request in KO Assets. The request wasn't created.
                                                                           <br /><br />
                                                                           Please try to create it again in KO Assets. If this problem occurs again, please contact the Asset Management team by clicking <a style="color: red;" href = "mailto: assetmanagers@coca-cola.com">here</a> for more information.
