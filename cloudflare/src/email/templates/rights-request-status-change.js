...
<title>Rights Request Status Update</title>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
																			<td valign="top" class="mcnTextContent"
																				...
																				Hello KO Assets User,<br />
                                                                                <p style="font-weight: normal;margin: 5px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #212121;font-family: 'Raleway', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px;line-height: 200%;text-align: left;">
                                                                                    Your Rights Request status is changed to <b>{{rightsRequestStatus}}</b> for the following Assets: 
                                                                                </p>
                                                                                <ul>
                                                                                    {{{assetDetailsText}}}
                                                                                </ul> <br />
